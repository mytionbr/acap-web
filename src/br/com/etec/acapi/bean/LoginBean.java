...
public class LoginBean {
	...
	public String acesso(){
		...
		if(funcionario.getNivelAcesso().equals("CAIXA")){
			System.out.println("Ganbiara é vida parte 1");
			return "_template5.xhtml";
		}else{
			System.out.println("Ganbiara é vida parte 2");
			return "_template4.xhtml";
		}
	...
	public String entrar(){
	   ...
	   // Mensagem mensagem = new Mensagem();
		//mensagem.exibirMensagem("Opa!","Usuario ou senha icorretos");
