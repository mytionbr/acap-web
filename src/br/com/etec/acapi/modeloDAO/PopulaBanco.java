...
public class PopulaBanco {
	public static void main(String[] args) {
		...
		Funcionario1.setNivelAcesso("CAIXA");
		...
		Funcionario2.setNivelAcesso("GERENTE");
		...
		Funcionario3.setNivelAcesso("CAIXA");
